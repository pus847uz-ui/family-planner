...
const TOPIC_MODULES = {
  ...
  // Единственный раздел, где тема не захватывает сообщения, а ведёт диалог: обычный
  // текст здесь — это обсуждение, где поесть, а не новая запись.
  еда: { key: "meals", title: "Приёмы пищи", icon: "🍽" },
};
